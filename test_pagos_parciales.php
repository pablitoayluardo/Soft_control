<?php
/**
 * Script de prueba para verificar la lógica de pagos parciales y completos
 */

require_once 'config.php';

echo "🔍 PRUEBA DE PAGOS PARCIALES Y COMPLETOS\n";
echo "========================================\n\n";
...
try {
    ...
    $stmt = $pdo->query("
        ...
        WHERE f.estatus = 'PENDIENTE' OR f.estatus = 'REGISTRADO'
    ...
    // 3. Simular corrección de estatus
    if (!empty($facturasCompletadas)) {
