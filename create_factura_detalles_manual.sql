-- =====================================================
-- SCRIPT PARA CREAR TABLA DE DETALLES DE FACTURAS
-- =====================================================
-- Ejecutar este script en tu base de datos MySQL
-- Puedes usar phpMyAdmin, MySQL Workbench, o línea de comandos

-- Verificar si la tabla facturas existe
SELECT COUNT(*) as total_facturas FROM information_schema.tables 
WHERE table_schema = 'globocit_soft_control' AND table_name = 'facturas';
