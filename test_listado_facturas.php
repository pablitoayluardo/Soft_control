...
try {
    ...
    if (count($facturas) > 0) {
        ...
        foreach ($facturas as $factura) {
            ...
            echo "<td style='border: 1px solid #ddd; padding: 8px;'>" . ($factura['fecha_emision'] ? date('d/m/Y H:i:s', strtotime($factura['fecha_emision'])) : 'N/A') . "</td>";
            ...
            echo "<td style='border: 1px solid #ddd; padding: 8px; color: " . ($factura['estatus'] === 'REGISTRADO' || $factura['estatus'] === 'PAGADO' ? '#28a745' : '#dc3545') . ";'>" . ($factura['estatus'] ?: 'REGISTRADO') . "</td>";
