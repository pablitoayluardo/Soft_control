...
echo "<h1>🧪 Test Listado Corregido</h1>";
...
echo "<ul>";
echo "<li><strong>Tabla con table-layout: fixed</strong> - Distribución automática de columnas</li>";
echo "<li><strong>Anchos de columnas optimizados</strong> - Porcentajes específicos para cada columna</li>";
...
echo "<li><strong>Sección agrandada</strong> - Más espacio para el listado</li>";
echo "</ul>";
echo "</div>";

echo "<div class='test-table-container'>";
echo "<div class='test-table-header'>";
echo "<h3>📋 Listado de Facturas (Simulado)</h3>";
echo "</div>";
...
for ($i = 1; $i <= 15; $i++) {
    ...
    echo "<td>Dirección de Prueba " . $i . " con dirección muy larga para probar el text-overflow</td>";
    echo "<td>$" . number_format(rand(100, 1000), 2) . "</td>";
    echo "<td>REGISTRADO</td>";
    echo "<td>$" . number_format(rand(0, 50), 2) . "</td>";
    echo "<td>$" . number_format(rand(100, 1000), 2) . "</td>";
    echo "<td>Observación de prueba " . $i . " con texto muy largo para probar el text-overflow</td>";
    echo "</tr>";
}
...
echo "<ul>";
echo "<li>✅ <strong>Sin scroll horizontal:</strong> La tabla se ajusta al ancho disponible</li>";
echo "<li>✅ <strong>Texto largo:</strong> Se corta con ... cuando es muy largo</li>";
echo "<li>✅ <strong>Columnas equilibradas:</strong> Distribución automática del espacio</li>";
echo "<li>✅ <strong>Sección agrandada:</strong> Más espacio para el contenido</li>";
...
echo "        console.log('❌ Hay scroll horizontal');";
echo "        document.title = 'Test Listado - ❌ Scroll Horizontal Detectado';";
echo "    } else {";
echo "        console.log('✅ Sin scroll horizontal');";
echo "        document.title = 'Test Listado - ✅ Sin Scroll Horizontal';";
echo "    }";
echo "}";
echo "";
