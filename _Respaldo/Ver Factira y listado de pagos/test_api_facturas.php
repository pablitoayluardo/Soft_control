<?php
// Script de prueba para verificar la API de facturas
echo "<h2>🔍 Test de API de Facturas</h2>";

// Simular la llamada a la API
$api_url = 'api/get_facturas_simple.php';

echo "<h3>1. Probando API directamente...</h3>";
...
if ($data) {
    ...
    if (isset($data['data']) && count($data['data']) > 0) {
        echo "<h3>3. Facturas encontradas:</h3>";
