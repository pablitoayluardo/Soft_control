<?php
// =====================================================
// TEST DIRECTO DE API PARA HOSTING
// =====================================================

echo "<h2>🔍 Test Directo de API - Hosting</h2>";
...
try {
    ...
    if ($infoFacturaExists) {
        ...
        echo "<h3>🔍 Probando Consulta de la API:</h3>";
        ...
        if (count($facturas) > 0) {
            echo "<h4>Primera factura:</h4>";
            echo "<pre>" . print_r($facturas[0], true) . "</pre>";
        }
...
try {
    // Usar file_get_contents para probar la API
